...
6.  Theoretical rainfall from 0 to 200 mm
7.  CN values
8.  Compute runoff using the SCS CN method
...
b)  Weighted contribution to discharge (separate contribution, first compute runoff and weight apply weights by fraction of area).
:::
